...
class FinalLayer(nn.Module):
    ...
    def forward(self, x, c):
        ...
        return x
class DiT(nn.Module):
    def __init__(self, img_size, num_classes, dim=64, patch_size=4, depth=3, heads=4, mlp_dim=512, in_channels=3):
    ...
    def forward(self, x, t, y=None):
        ...
        if y is not None:
            ...
            c_emb = self.label_mlp(c_emb)
            # time embedding과 class embedding을 더해줌
            t = t + c_emb
        else:
